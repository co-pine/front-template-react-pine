...
/** 此处后端没有提供注释 GET /user/login/miniapp */
export async function userLoginByWxMiniapp(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.userLoginByWxMiniappParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseLoginUserVO>('/user/login/miniapp', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** 此处后端没有提供注释 POST /user/login/wx_mp */
export async function userLoginByWxMp(
  body: API.UserLoginByWxMpRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseLoginUserVO>('/user/login/wx_mp', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /user/login/wx_mp/get_scene */
export async function userLoginByWxMpGetScene(options?: { [key: string]: any }) {
  return request<API.BaseResponseUserLoginByWxMpGetSceneResponse>('/user/login/wx_mp/get_scene', {
    method: 'POST',
    ...(options || {}),
  });
}
